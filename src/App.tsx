    ...
    <Card className="w-[672px]">
      ...
      <CardContent className="flex flex-col">
        <div className="flex flex-col space-y-4">
          <div>
            <p className="text-sm text-muted-foreground mb-3">Select which users automatically get Frontier features and agents in their applications. These users must have a M365 Copilot license to experience Frontier. </p>
          </div>
...
export default function App() {
  ...
  const publishTextUpdatesUnified = () => {
    ...
    setSavedTextConfigUnified(getInitialTextConfig())
    setTextConfigUnified(getInitialTextConfig())
